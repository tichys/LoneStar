...
/datum/job/enclave_scientist
	...
	outfit = /datum/outfit/job/enclave_scientist

	access = list(70)

/datum/outfit/job/enclave_scientist
	name = "Enclave Scientist"
	backpack = null
	gloves = /obj/item/clothing/gloves/f13/military
	uniform = /obj/item/clothing/under/f13/enclave_officer
	shoes = /obj/item/clothing/shoes/f13/military
	suit = /obj/item/clothing/suit/bio_suit/sciencesuit
	head = /obj/item/clothing/head/bio_hood/science
	belt = /obj/item/weapon/storage/belt/military/enclavearmy/full
	id = /obj/item/weapon/card/id/enclave
